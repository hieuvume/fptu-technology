                ...
                <div className="single-footer-caption">
                  ...
                  <div className="footer-tittle">
                    <div className="footer-pera">
                      <p>
                        Welcome to FPTU Technology! Our platform is a premier
                        forum dedicated to the latest in technology, offering a
                        vibrant space for tech enthusiasts, professionals, and
                        students to share knowledge and insights. Stay updated
                        with the newest trends, innovative solutions, and expert
