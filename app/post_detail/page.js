                        ...
                        <div className="col-lg-12">
                            <div className="trending-tittle">
                                ...
                                <div className="trending-animated">
                                    <div
                                        id="ticker-wrapper-1718215637641"
                                        className="ticker-wrapper has-js left"
                                    >
                                        <div id="ticker-1718215637641" className="ticker">
                                            <div id="ticker-title-1718215637641" className="ticker-title">
                                                <span />
                                            </div>
                                            <p
                                                id="ticker-content-1718215637641"
                                            ...
                                            <div
                                                id="ticker-swipe-1718215637641"
                                                className="ticker-swipe"
                                                style={{ left: 20, marginLeft: "355.1px" }}
                                            >
                                                <span style={{ display: "block" }}>{/* */}</span>
                                            </div>
                                        </div>
                                        <ul
                                            id="ticker-controls-1718215637641"
                                            className="ticker-controls"
                                        >
                                            <li
                                                id="play-pause-1718215637641"
                                                className="jnt-play-pause controls"
                                            >
                                                <a href="">{/* */}</a>
                                            </li>
                                            <li id="prev-1718215637641" className="jnt-prev controls">
                                                <a href="">{/* */}</a>
                                            </li>
                                            <li id="next-1718215637641" className="jnt-next controls">
                                                <a href="">{/* */}</a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div className="about-right mb-90">
                                ...
                                <div className="about-prea">
                                    ...
                                    <p className="about-pera1 mb-25">
                                        ...
                                        eyepiece. The reflector telescope has a concave lens which means
                                        it bends in. It uses mirrors to focus the image that you
                                        eventually see. Collimation is a term fo Moms are like…buttons?
                                        Moms are like glue. Moms are like pizza crusts. Moms are the
                                        ones who make sure things happen—from birth to school lunch.
                                    </p>
                                    <p className="about-pera1 mb-25">
